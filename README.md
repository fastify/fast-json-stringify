...
- if the schema describes a number and a Infinity, NaN, null or a boolean was given,
...
- if the schema describes a number and a non-numeric string or number was given,
the serialization fails throwing an error
