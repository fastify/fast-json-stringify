                      ...
                      if (valid0) {
                        ...
                        if (valid0) {
                          if (data.exclusiveMaximum !== undefined) {
                            const data10 = data.exclusiveMaximum
                          ...
                          if (valid0) {
                            ...
                            if (valid0) {
                              if (data.exclusiveMinimum !== undefined) {
                                const data12 = data.exclusiveMinimum
                                              ...
                                              if (valid0) {
                                                ...
                                                if (valid0) {
                                                  if (data.maxProperties !== undefined) {
                                                    const data22 = data.maxProperties
                                                          ...
                                                          if (valid0) {
                                                            ...
                                                            if (valid0) {
                                                              if (data.patternProperties !== undefined) {
                                                                const data31 = data.patternProperties
                                                              ...
                                                              if (valid0) {
                                                                if (data.dependencies !== undefined) {
                                                                  const data33 = data.dependencies
                                                                  const _errs68 = errors
                                                                  if (errors === _errs68) {
                                                                    if (data33 && typeof data33 === 'object' && !Array.isArray(data33)) {
                                                                      for (const key4 in data33) {
                                                                        const data34 = data33[key4]
